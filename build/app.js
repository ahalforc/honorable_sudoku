...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/honorable_sudoku","GOAPP_STATIC_RESOURCES_URL":"/honorable_sudoku/web","GOAPP_VERSION":"f30cec0163e418706abf11ad78b35a4898d00841"};
  ...
  if ("serviceWorker" in navigator) {
    try {
      const registration = await navigator.serviceWorker.register(
        "/honorable_sudoku/app-worker.js"
      );
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/honorable_sudoku/web/app.wasm", showProgress),
      go.importObject
    );
