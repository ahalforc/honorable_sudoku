...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "f30cec0163e418706abf11ad78b35a4898d00841";
const resourcesToCache = ["https://raw.githubusercontent.com/maxence-charriere/go-app/master/docs/web/icon.png","/honorable_sudoku/web/sudoku.css","/honorable_sudoku/web/app.wasm","/honorable_sudoku/wasm_exec.js","/honorable_sudoku/manifest.webmanifest","/honorable_sudoku/app.js","/honorable_sudoku/app.css","/honorable_sudoku"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker f30cec0163e418706abf11ad78b35a4898d00841");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker f30cec0163e418706abf11ad78b35a4898d00841 is activated");
  } catch (error) {
