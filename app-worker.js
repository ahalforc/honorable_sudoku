...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "be96d32e725fdb7df31a7624edf8453932643d18";
...
self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker be96d32e725fdb7df31a7624edf8453932643d18");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker be96d32e725fdb7df31a7624edf8453932643d18 is activated");
  } catch (error) {
